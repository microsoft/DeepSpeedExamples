...
def load_tf_weights_in_bert(model, config, tf_checkpoint_path, voc_size_diff):
...
def convert_tf_ckpt_to_deepspeed(tf_checkpoint_path, bert_config_file, deepspeed_dump_dir, args):
    ...
    load_tf_weights_in_bert(model.module, config, tf_checkpoint_path, voc_size_diff )
...
if __name__ == "__main__":
    ...
    convert_tf_ckpt_to_deepspeed(args.tf_checkpoint_path, args.bert_config_file, args.deepspeed_dump_dir , args)
