...
from scripts.demo import perform_inference



def parse_args():
    parser = argparse.ArgumentParser(description='Demo of LEAP')
    parser.add_argument(
    ...
    parser.add_argument(
        '--permute', action='store_true', default=False, help='whether to test all permutation of inputs')
...
def main():
    ...
    # specify the demo image path, test on iphone-captures or amazon product images
    if 'amazon' in config.exp_name:
        path = 'assets/real_image/amazon'
    elif 'real' in config.exp_name:
        path = 'assets/real_image/real_masked'
    else:
