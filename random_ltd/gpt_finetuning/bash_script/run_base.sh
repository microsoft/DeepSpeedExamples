...
python -m torch.distributed.launch --nproc_per_node=1 \
    ...
    --num_train_epochs 2 \
    --deepspeed_config config/ds_config_gpt_base.json \
    --deepspeed --seed 1234\
    --output_dir ./output2/check #&> ./output2/check/train_with_real_kernel.log # ./output1/check/train_with_kernel_fp16.log
