...
def train_base(args):
    ...
    for idx, batch in enumerate(dataloader):
        ...
        micro_batches = idx+1
        if micro_batches % engine.gradient_accumulation_steps() == 0:
            step = micro_batches // engine.gradient_accumulation_steps()
...
def train_pipe(args, part='parameters'):
    ...
    torch.manual_seed(args.seed)
    net = vgg19(num_classes=10)
    net = PipelineModule(layers=to_layers(net),
